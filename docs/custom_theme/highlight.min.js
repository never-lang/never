/*
  Highlight.js 10.0.0-beta.0 (772dc1fd)
...
hljs.registerLanguage("never",function(){"use strict";return function(e){var n={keyword:"catch do enum else extern for func if in let match record throw var while",type:"bool char float int string",literal:"false nil true",built_in:"assert assertb assertf chr cos exp length log ord pow print printb printc printf prints read sin sqrt str strf tan"},a={className:"string",begin:'"',end:'"'},s={className:"type",begin:"\\b[A-Z][0-9A-Za-z$_]*",relevance:0},r={className:"array",begin:"\\[",end:"\\]"};return{name:"never",aliases:["Never "],disableAutodetect:!0,case_insensitive:!1,keywords:n,contains:[s,{className:"function",beginKeywords:"func",end:"{",excludeEnd:!0,contains:[e.inherit(e.TITLE_MODE,{begin:/[A-Za-z$_][0-9A-Za-z$_]*/}),{className:"params",begin:/\(/,end:/\)/,keywords:n,contains:[r,s]},{className:"params",begin:/->/,end:/\{/,endsParent:!0,keywords:n,contains:[r,s]}]},{className:"function",beginKeywords:"enum record",end:"{",excludeEnd:!0,contains:[e.inherit(e.TITLE_MODE,{begin:/[A-Za-z$_][0-9A-Za-z$_]*/}),{className:"params",begin:/\{/,end:/\}/,endsParent:!0,keywords:n,contains:[r,s]}]},{className:"function",begin:"extern",end:"[\n\r]",excludeBeging:!0,keywords:n,contains:[a,{className:"title",begin:"\\bfunc",end:/[A-Za-z$_][0-9A-Za-z$_]*/,excludeBegin:!0},{className:"params",begin:/\{/,end:/\}/,endsParent:!0,contains:[r,s]}]},{className:"number",begin:"\\b0[xX][0-9A-F]+\\b|\\b[0-9]+\\b",relevance:0},a,e.C_BLOCK_COMMENT_MODE,e.HASH_COMMENT_MODE]}}}());
